...
//    조회
    ...
    public List<OrderDTO> showByItemName(String itemName){
        return orderDAO.findByItemName(itemName);
    }

//    주문 수량 조회
    public int showCount(String itemName){
        return orderDAO.findByItemName(itemName).stream().mapToInt(order -> order.getItemCount()).sum();
    }
...
//    상품 전체 조회
    public List<ItemVO> showAllItem(){return itemDAO.findAll();}
}
